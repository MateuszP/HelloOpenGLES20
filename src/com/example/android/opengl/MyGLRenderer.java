...
public class MyGLRenderer implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceCreated(GL10 unused, EGLConfig config) {
        ...
        mTriangle1 = new Triangle(1);
        mTriangle2 = new Triangle(2);
        mTriangle3 = new Triangle(3); 
        mTriangle4 = new Triangle(4);
        mTriangle5 = new Triangle(5);
        mTriangle6 = new Triangle(6);
        //mSquare   = new Square();
    }
